...
/// 播放激励视频广告
/// </summary>
/// <param name="adId">广告ID，用于标识要播放的激励视频广告</param>
/// <param name="onClose">广告关闭回调函数，参数1表示广告是否有效观看完成，参数2表示广告播放时长</param>
/// <param name="onError">广告错误回调函数，参数1表示错误码，参数2表示错误信息</param>
public void PlayRewardedAd(string adId,
    ...
    {
        TTSDK.LaunchOption launchOption = TT.GetLaunchOptionsSync();
        Debug.Log("clickid：" + launchOption.Query["clickid"]);
